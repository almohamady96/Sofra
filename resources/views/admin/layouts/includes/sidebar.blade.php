...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <div class="user-panel">
            ...
            <div class="pull-left info">
                <p>{{Auth::user()->name}}</p>
                <a href="#"><i class="fa fa-circle text-success"></i> {{Auth::user()->first()->name}}</a>
    ...
    <!-- /.search form -->
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview">
                <a href="{{url('admin/restaurant')}}"><i class="fa fa-cutlery"></i> <span>المطاعم</span> <i
          ...
          <li><a href="{{url('admin/transaction')}}"><i class="fa fa-money"></i> العمليات المالية</a></li>
            ...
            <li><a href="{{url('admin/category')}}"><i class="fa fa-cutlery"></i> تصنيفات المطاعم</a></li>
           {{-- <li><a href="{{url('admin/{restaurant}/item')}}"><i class="fa fa-cutlery"></i>أصناف الطعام</a></li>--}}
        ...
        <!-- Optionally, you can add icons to the links -->
            ...
            <li><a href="{{url('admin/payment')}}"><i class="fa fa-cc-visa"></i> طرق الدفع</a></li>
            ...
            <li><a href="{{url('admin/setting')}}"><i class="fa fa-cogs"></i> الاعدادات</a></li>
            <li><a href="{{url('admin/setting_v2')}}"><i class="fa fa-cogs"></i> الاعدادات اصدار 2</a></li>
            <li><a href="{{url('admin/user')}}"><i class="fa fa-key"></i>المستخدمين</a></li>
