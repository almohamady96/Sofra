    ...
    <section class="invoice">
        ...
        <div class="row invoice-info">
            <div class="col-sm-4 invoice-col">
                طلب من
                <address>
                    <i class="fa fa-angle-left" aria-hidden="true"></i>  {{$order->client->name}}
                    <br>
                    <i class="fa fa-angle-left" aria-hidden="true"></i>   الهاتف : {{$order->client->phone}}
                    <br>
        ...
        <div class="row no-print">
            <div class="col-xs-12">
                <a href="{{url('layouts/print/'.$order->id)}}" target="_blank" class="btn btn-default">
